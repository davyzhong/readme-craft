#!/usr/bin/env node
import { createRequire as __readmeCraftCreateRequire } from 'node:module'; const require = __readmeCraftCreateRequire(import.meta.url);
...
// <define:__README_CRAFT_EMBEDDED__>
var define_README_CRAFT_EMBEDDED_default;
var init_define_README_CRAFT_EMBEDDED = __esm({
  "<define:__README_CRAFT_EMBEDDED__>"() {
    define_README_CRAFT_EMBEDDED_default = { rulesYaml: '# readme-craft \u89C4\u5219\u89C4\u8303\uFF08\u552F\u4E00\u4E8B\u5B9E\u6E90\uFF09\n# \u7248\u672C\u4E0E SKILL frontmatter / package.json \u4E09\u5904\u4E00\u81F4\uFF08P9\uFF09\uFF0C\u7531 validate \u5F3A\u5236\u6821\u9A8C\u3002\n# \u5185\u90E8 ID \u96F6\u586B\u5145 T01..T19 / A01..A13\uFF1B\u6563\u6587\u6587\u6863\u4FDD\u6301 T1..T19 / A1..A13\uFF0C\u6620\u5C04\u7531 generate \u7EF4\u62A4\u3002\nversion: 3.0.0-alpha.0\n\nrules:\n  - id: T01\n    title: \u89C6\u89C9\u9524\n    axis: visual\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u9996\u5C4F\u7528\u4E2D\u592E logo + tagline + hero \u89C6\u89C9\u5EFA\u7ACB\u8FA8\u8BC6\u5EA6\n    scores:\n      "0": \u9996\u5C4F\u7EAF\u6587\u5B57\uFF0C\u65E0\u4EFB\u4F55\u89C6\u89C9\u5143\u7D20\n      "1": \u6709\u6807\u9898\u88C5\u9970\uFF08\u5982 emoji\uFF09\uFF0C\u4F46\u65E0 hero \u56FE\n      "2": \u6709 hero \u89C6\u89C9\u4F46\u4E0E\u4EA7\u54C1\u5B9E\u9645\u754C\u9762\u65E0\u5173\u6216\u4E25\u91CD\u8FC7\u65F6\n      "3": \u9996\u5C4F\u6709\u5C45\u4E2D\u7684 logo/tagline \u548C\u4E00\u5F20\u771F\u5B9E\u7684 hero \u89C6\u89C9\n      "4": hero \u89C6\u89C9\u4E3A\u771F\u5B9E\u622A\u56FE/\u5F55\u5C4F\u6216\u67B6\u6784\u56FE\uFF0C\u4E14\u4E0E\u5F53\u524D\u7248\u672C\u4E00\u81F4\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u63D0\u4F9B\u6D45\u8272/\u6DF1\u8272\u9002\u914D\u6216\u52A8\u6001 SVG banner \u7B49\u8FDB\u9636\u5F62\u6001\n    evidence: [hero-visual, logo-tagline]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T02\n    title: \u4E09\u79D2\u4EF7\u503C\u4E3B\u5F20\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u7528\u4E00\u4E24\u53E5\u8BDD\u8BB2\u6E05\u505A\u4EC0\u4E48\u3001\u7ED9\u8C01\u7528\u3001\u4E3A\u4EC0\u4E48\u9009\u4F60\n    scores:\n      "0": \u627E\u4E0D\u5230\u4EFB\u4F55\u9879\u76EE\u63CF\u8FF0\n      "1": \u6709\u63CF\u8FF0\u4F46\u53EA\u8BB2\u505A\u4EC0\u4E48\uFF0C\u770B\u4E0D\u51FA\u7ED9\u8C01\u7528\u6216\u4F18\u52BF\n      "2": \u8BB2\u6E05\u505A\u4EC0\u4E48+\u7ED9\u8C01\u7528\uFF0C\u4F46\u65E0\u5DEE\u5F02\u5316\u4F18\u52BF\n      "3": \u4E00\u53E5\u8BDD\u8986\u76D6\u505A\u4EC0\u4E48+\u7ED9\u8C01\u7528+\u72EC\u7279\u4F18\u52BF\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u7B2C\u4E8C\u53E5\u7ED9\u51FA\u53EF\u4FE1\u7684\u9009\u578B\u7406\u7531\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u964C\u751F\u4EBA 30 \u79D2\u6D4B\u8BD5\u53EF\u590D\u8FF0\u9879\u76EE\u5B9A\u4F4D\n    evidence: [value-proposition]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T03\n    title: Badge \u77E9\u9635\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u7528 4-7 \u4E2A\u6807\u51C6\u5316 badge \u5EFA\u7ACB\u53EF\u4FE1\u5EA6\n    scores:\n      "0": \u6CA1\u6709\u4EFB\u4F55 badge\n      "1": 1-3 \u4E2A badge\uFF0C\u6216\u8D85\u8FC7 10 \u4E2A\u5931\u7126\n      "2": 4-7 \u4E2A badge \u4F46\u975E shields.io \u6807\u51C6\u683C\u5F0F\n      "3": 4-7 \u4E2A shields.io badge\uFF0C\u542B\u8BB8\u53EF\u8BC1\u4E0E\u7248\u672C/\u72B6\u6001\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u542B CI \u72B6\u6001\u4E0E\u4E0B\u8F7D\u91CF/star \u89C4\u6A21\u4FE1\u53F7\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u542B security badge \u4E0E\u6587\u6863\u5165\u53E3\n    evidence: [badge-count, shields-io-format]\n    evaluator: deterministic\n    browser_safe: true\n    thresholds: { partial: 2, pass: 3 }\n\n  - id: T04\n    title: \u5B89\u88C5\u591A\u8DEF\u9F50\u53D1\n    axis: structure\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u8BA9\u76EE\u6807\u7528\u6237\u627E\u5230\u771F\u5B9E\u53EF\u7528\u7684\u5B89\u88C5\u8DEF\u5F84\uFF0C\u8986\u76D6\u6B63\u5F0F\u652F\u6301\u7684\u5E73\u53F0\n    scores:\n      "0": \u6CA1\u6709\u5B89\u88C5\u8BF4\u660E\n      "1": \u6709\u63CF\u8FF0\u4F46\u6CA1\u6709\u53EF\u6267\u884C\u547D\u4EE4\n      "2": \u6709\u4E3B\u5E73\u53F0\u547D\u4EE4\uFF0C\u4F46\u672A\u63D0\u4F9B\u9A8C\u8BC1\u8BC1\u636E\n      "3": \u4E3B\u5E73\u53F0\u6709\u7ECF\u8FC7\u9A8C\u8BC1\u7684\u5B89\u88C5\u547D\u4EE4\uFF0C\u6BCF\u8DEF\u5355\u884C\u53EF\u590D\u5236\n      "4": \u6B63\u5F0F\u652F\u6301\u7684\u5E73\u53F0\u5747\u6709\u547D\u4EE4\uFF0C\u5C11\u91CF\u9A8C\u8BC1\u8BC1\u636E\u7F3A\u5931\n      "5": \u6240\u6709\u6B63\u5F0F\u652F\u6301\u7684\u5E73\u53F0\u90FD\u6709\u7ECF\u8FC7\u9A8C\u8BC1\u7684\u5B89\u88C5\u8DEF\u5F84\n    evidence: [executable-command, supported-platforms]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 3 }\n\n  - id: T05\n    title: 30 \u79D2\u8BD5\u7528 + 60 \u79D2 Quickstart\n    axis: structure\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u4ECE\u96F6\u5230 demo \u4E0D\u8D85\u8FC7 60 \u79D2\uFF0CWeb/GUI \u9879\u76EE\u63D0\u4F9B\u96F6\u90E8\u7F72\u8BD5\u7528\u5165\u53E3\n    scores:\n      "0": \u6CA1\u6709 Quickstart\n      "1": \u6709\u6B65\u9AA4\u4F46\u4E0D\u53EF\u590D\u5236\u6216\u7F3A\u771F\u5B9E\u8F93\u51FA\n      "2": 3-5 \u4E2A\u7F16\u53F7\u6B65\u9AA4\u53EF\u590D\u5236\uFF0C\u4F46\u65E0\u8F93\u51FA\u8BC1\u636E\n      "3": Quickstart \u914D\u771F\u5B9E\u7EC8\u7AEF/GUI \u8F93\u51FA\u622A\u56FE\uFF0C60 \u79D2\u53EF\u8DD1\u901A\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14 Web/GUI \u9879\u76EE\u9876\u90E8\u6709 Deploy/\u8BD5\u7528\u6309\u94AE\uFF08CLI/\u5E93\u8C41\u514D\u8BE5\u5B50\u9879\uFF09\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u7ECF\u964C\u751F\u4EBA\u8BA1\u65F6\u5B9E\u6D4B 60 \u79D2\u5185\u8DD1\u901A\n    evidence: [quickstart-steps, real-output-screenshot]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T06\n    title: \u89C6\u89C9\u77E9\u9635\n    axis: visual\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: 3 \u5F20\u622A\u56FE\u4E00\u7EC4 + \u590D\u6742 GUI \u9879\u76EE 1 \u6BB5\u89C6\u9891\uFF0C\u5C55\u793A\u4EA7\u54C1\u771F\u5B9E\u9762\u8C8C\uFF1B\u975E GUI \u7C7B\u578B\uFF08cli/library/service/knowledge-base\uFF09\u65E0\u56FE\u50CF/\u89C6\u9891\u5F15\u7528\u65F6\u8BA1 N/A\uFF08\u6761\u4EF6\u9879\uFF09\n    scores:\n      "0": \u5168\u6587 0 \u5F20\u56FE\n      "1": \u53EA\u6709 1 \u5F20\u5B64\u7ACB\u56FE\u6216\u6563\u843D\u65E0\u8282\u594F\n      "2": \u6709\u622A\u56FE\u7EC4\u4F46\u7F3A alt \u6216\u5C3A\u5BF8\u4E0D\u7EDF\u4E00\n      "3": 3 \u5F20\u622A\u56FE\u6210\u7EC4\u3001width\u2248270\u3001\u53EF\u70B9\u51FB\u653E\u5927\u3001\u5E26\u5177\u4F53 alt\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u590D\u6742 GUI \u9879\u76EE\u542B \u226460 \u79D2\u6F14\u793A\u89C6\u9891\uFF08\u5176\u4ED6\u7C7B\u578B\u53EF\u8C41\u514D\u89C6\u9891\u5B50\u9879\uFF09\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u622A\u56FE\u5747\u7531\u81EA\u52A8\u5316\u811A\u672C\u4EA7\u51FA\uFF08\u8854\u63A5 T18\uFF09\n    evidence: [screenshot-group, image-alt]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T07\n    title: \u5356\u70B9\u7F16\u53F7\u6E05\u5355\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: 4-6 \u6761\u300C\u7C97\u4F53\u5173\u952E\u8BCD + \u4E00\u884C\u91CF\u5316\u6536\u76CA\u300D\uFF0C\u628A\u505A\u4E86\u4EC0\u4E48\u7FFB\u8BD1\u6210\u7528\u6237\u80FD\u5F97\u5230\u4EC0\u4E48\n    scores:\n      "0": \u6CA1\u6709\u5356\u70B9\u6E05\u5355\n      "1": \u2705 \u5217\u8868\u5806\u780C\uFF08\u505A\u4E86\u4EC0\u4E48\uFF09\uFF0C\u65E0\u7528\u6237\u6536\u76CA\u89C6\u89D2\n      "2": \u6709\u7F16\u53F7\u5356\u70B9\u4F46\u5168\u662F\u7A7A\u5F62\u5BB9\u8BCD\uFF08\u5FEB/\u7B80\u5355/\u5F3A\u5927\uFF09\n      "3": 4-6 \u6761\u5356\u70B9\uFF0C\u6BCF\u6761\u7C97\u4F53\u5173\u952E\u8BCD + \u5177\u4F53\u6536\u76CA\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u6536\u76CA\u53EF\u91CF\u5316\u6216\u6709\u636E\u53EF\u67E5\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u6BCF\u6761\u6536\u76CA\u53EF\u6EAF\u6E90\u5230\u8BC1\u636E\uFF08benchmark/\u6587\u6863/\u6848\u4F8B\uFF09\n    evidence: [numbered-selling-points, quantified-benefit]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T08\n    title: Feature \u5206\u7EC4 + Ecosystem\n    axis: visual\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u529F\u80FD\u6309\u7EF4\u5EA6\u5206\u7EC4\uFF1B\u591A\u6A21\u5757\u9879\u76EE\u8BF4\u660E\u751F\u6001\u4F4D\u7F6E\n    scores:\n      "0": \u529F\u80FD\u5168\u90E8\u5806\u5728\u4E00\u4E2A\u65E0\u7ED3\u6784\u5217\u8868\n      "1": \u6709\u5206\u7EC4\u4F46\u7EF4\u5EA6\u6DF7\u4E71\u6216\u7EC4\u6570\u5931\u5F53\uFF08<2 \u6216 >6\uFF09\n      "2": \u6309\u7EF4\u5EA6\u5206 3-5 \u7EC4\uFF0C\u4F46\u6761\u76EE\u63CF\u8FF0\u4E0D\u4E00\u81F4\n      "3": 3-5 \u7EC4\u3001\u6BCF\u7EC4\u4E8C\u7EA7\u6807\u9898\u3001\u6761\u76EE\u7EDF\u4E00\u4E3A emoji+\u7C97\u4F53\u8BCD+\u4E00\u53E5\u8BDD\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u591A\u6A21\u5757\u9879\u76EE\u6709 Ecosystem \u7AE0\u8282\uFF08\u5355\u6A21\u5757\u9879\u76EE\u8C41\u514D T8b\uFF09\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u751F\u6001\u6761\u76EE\u5747\u94FE\u63A5\u5230\u771F\u5B9E\u53EF\u8BBF\u95EE\u7684\u5144\u5F1F\u9879\u76EE\n    evidence: [feature-groups, ecosystem-section]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T09\n    title: \u67B6\u6784\u56FE\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u590D\u6742\u9879\u76EE\u7528\u4E00\u5F20\u56FE\u8BF4\u6E05\u7EC4\u4EF6\u3001\u5173\u7CFB\u4E0E\u6570\u636E\u6D41\uFF1B\u7B80\u5355 CLI \u53EF\u8C41\u514D\n    scores:\n      "0": \u590D\u6742\u9879\u76EE\u5B8C\u5168\u6CA1\u6709\u67B6\u6784\u56FE\uFF08\u7B80\u5355 CLI \u5224 N/A\uFF09\n      "1": \u7528\u7EAF\u6587\u5B57\u6BB5\u843D\u63CF\u8FF0\u7EC4\u4EF6\u5173\u7CFB\n      "2": \u6709\u56FE\u4F46\u7F3A\u7EC4\u4EF6\u3001\u5173\u7CFB\u6216\u6570\u636E\u6D41\u4E09\u8005\u4E4B\u4E00\n      "3": \u4E00\u5F20\u56FE\u8986\u76D6\u7EC4\u4EF6+\u5173\u7CFB+\u6570\u636E\u6D41\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u4F7F\u7528 mermaid \u7B49\u53EF\u7248\u672C\u63A7\u5236\u7684\u683C\u5F0F\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u56FE\u4E0E\u4EE3\u7801\u7ED3\u6784\u540C\u6B65\u7EF4\u62A4\uFF08\u6709\u66F4\u65B0\u673A\u5236\u8BF4\u660E\uFF09\n    evidence: [architecture-diagram]\n    evaluator: deterministic\n    browser_safe: true\n    thresholds: { partial: 2, pass: 3 }\n\n  - id: T10\n    title: \u5BF9\u7167\u8868\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u7528\u8868\u683C\u56DE\u7B54\u4E3A\u4EC0\u4E48\u7528\u6211\uFF1A\u540C\u7C7B\u5BF9\u6BD4 / \u5E73\u53F0\u652F\u6301 / \u591A\u8BED\u8A00\u652F\u6301\u81F3\u5C11\u5176\u4E00\n    scores:\n      "0": \u6CA1\u6709\u4EFB\u4F55\u8868\u683C\n      "1": \u6709\u8868\u683C\u4F46\u4E0E\u5DEE\u5F02\u5316\u65E0\u5173\uFF08\u7EAF\u88C5\u9970\uFF09\n      "2": \u6709\u540C\u7C7B/\u5E73\u53F0/\u8BED\u8A00\u5BF9\u7167\u8868\uFF0C\u4F46\u7EF4\u5EA6\u8FC7\u5C11\n      "3": \u81F3\u5C11\u4E00\u4E2A\u8A00\u4E4B\u6709\u7269\u7684\u5BF9\u7167\u8868\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u540C\u7C7B\u5BF9\u6BD4\u6709\u7406\u6709\u636E\u4E0D\u8D2C\u4F4E\u5BF9\u624B\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u5BF9\u7167\u7EF4\u5EA6\u8986\u76D6\u8BFB\u8005\u4E3B\u8981\u51B3\u7B56\u56E0\u7D20\n    evidence: [comparison-table]\n    evaluator: deterministic\n    browser_safe: true\n    thresholds: { partial: 1, pass: 3 }\n\n  - id: T11\n    title: \u5F15\u7528 / \u80CC\u4E66\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u4F01\u4E1A logo / \u7528\u6237 quote / \u5B66\u672F\u5F15\u7528\u81F3\u5C11\u5176\u4E00\uFF0C\u4E14\u6BCF\u6761\u53EF\u6EAF\u6E90\uFF1B\u65E9\u671F\u9879\u76EE\u53EF\u6807\u5EFA\u8BBE\u4E2D\n    scores:\n      "0": \u4F2A\u9020\u7528\u6237\u3001\u5BA2\u6237\u3001\u6307\u6807\u6216\u5F15\u7528\uFF08\u76F4\u63A5 fail\uFF0C\u4E0D\u9002\u7528\u8C41\u514D\uFF09\n      "1": \u65E0\u4EFB\u4F55\u5F15\u7528\uFF0C\u4E5F\u672A\u6807\u6CE8\u5EFA\u8BBE\u4E2D\uFF08\u65E9\u671F\u9879\u76EE\u53EF\u5224 N/A \u5E76\u6CE8\u660E\uFF09\n      "2": \u6709\u5F15\u7528\u4F46\u4E0D\u53EF\u6EAF\u6E90\n      "3": \u81F3\u5C11\u4E00\u6761\u5F15\u7528\u53EF\u6EAF\u6E90\u5230\u539F\u59CB\u9875\u9762\uFF0Clogo \u6709\u6388\u6743\u8BF4\u660E\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u5F62\u5F0F\u591A\u6837\uFF08quote + logo \u6216\u5B66\u672F cite\uFF09\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u5F15\u7528\u5B9A\u671F\u6838\u9A8C\u6709\u6548\n    evidence: [traceable-reference]\n    evaluator: agent-reviewed\n    thresholds: { partial: 1, pass: 3 }\n\n  - id: T12\n    title: \u6536\u5C3E\u4E94\u4EF6\u5957\n    axis: structure\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: License + Contributing + CoC + Security + Sponsors/Acknowledgements\n    scores:\n      "0": \u4E94\u4EF6\u5957\u5168\u7F3A\n      "1": \u53EA\u6709 License\n      "2": License + Contributing\uFF0C\u7F3A CoC / Security\n      "3": License + Contributing + CoC + Security \u9F50\u5907\u4E14\u6709\u94FE\u63A5\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u6709 Sponsors/Acknowledgements\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u6709 Roadmap \u6216 Community Stats \u7B49\u52A0\u5206\u9879\n    evidence: [governance-files, readme-links]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T13\n    title: i18n \u89C4\u8303\n    axis: inclusive\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u591A\u8BED\u8A00\u6587\u4EF6\u7528 README.<BCP47>.md \u547D\u540D\uFF0C\u5E76\u660E\u786E\u652F\u6301\u7B56\u7565\uFF1B\u65E0\u591A\u8BED\u8A00\u4FE1\u53F7\u65F6\u662F\u5426\u5B58\u5728\u6D77\u5916\u7528\u6237\u5C5E\u5916\u90E8\u4E8B\u5B9E\uFF0C\u8BA1 unverified \u800C\u975E 0 \u5206\uFF08\u6761\u4EF6\u9879\uFF09\n    scores:\n      "0": \u6709\u6D77\u5916\u7528\u6237\u4F46\u53EA\u6709\u5355\u4E00\u8BED\u8A00\u4E14\u672A\u8BF4\u660E\u7B56\u7565\uFF08\u89E6\u53D1 A09\uFF09\n      "1": \u6709\u591A\u8BED\u8A00\u5185\u5BB9\u4F46\u547D\u540D\u4E0D\u7B26\u5408 BCP 47\n      "2": \u547D\u540D\u5408\u89C4\u4F46\u65E0\u652F\u6301\u7B56\u7565\u8BF4\u660E\n      "3": README.<BCP47>.md \u547D\u540D\u5408\u89C4 + \u660E\u786E\u652F\u6301\u7B56\u7565\uFF08\u542B\u300C\u4EC5\u5355\u8BED\u8A00\uFF0C\u6B22\u8FCE PR\u300D\u60C5\u5F62\uFF09\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u8BED\u8A00\u5207\u6362\u96C6\u4E2D\u5728\u9876\u90E8\u4E00\u5904\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u65E0\u7FFB\u8BD1\u5217\u9635\uFF08\u56FD\u65D7\u94FE\u63A5 \u22645 \u6216\u76EE\u5F55\u5206\u6D41\uFF09\n    evidence: [bcp47-files, support-policy]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 1, pass: 3 }\n\n  - id: T14\n    title: \u5305\u5BB9\u6027\u8BED\u8A00\n    axis: inclusive\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: they \u5355\u6570\u3001\u591A\u5143\u793A\u4F8B\u4EBA\u540D\u3001\u53BB\u6027\u522B\u9ED8\u8BA4\u3001\u7B2C\u4E8C\u4EBA\u79F0\n    scores:\n      "0": \u5B58\u5728\u660E\u663E\u6027\u522B/\u6587\u5316\u504F\u89C1\u7528\u8BCD\n      "1": \u9ED8\u8BA4\u6307\u4EE3\u7528 he/she\uFF0C\u793A\u4F8B\u4EBA\u540D\u5355\u4E00\u6587\u5316\u80CC\u666F\n      "2": \u90E8\u5206\u4FEE\u6B63\u4F46\u4ECD\u6709 the user / manpower \u7C7B\u6B8B\u7559\n      "3": they \u5355\u6570 + \u591A\u5143\u4EBA\u540D + \u53BB\u6027\u522B\u9ED8\u8BA4\u8BCD\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u7B2C\u4E8C\u4EBA\u79F0\u7EDF\u4E00\u7528 you\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u7ECF\u5305\u5BB9\u6027\u8BED\u8A00\u5DE5\u5177\u6216 LLM \u590D\u67E5\u901A\u8FC7\n    evidence: [inclusive-language-review]\n    evaluator: agent-reviewed\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T15\n    title: LLM \u53CB\u597D\u5143\u6570\u636E\n    axis: ai\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u8BED\u4E49\u6807\u9898\u3001\u6E05\u6670\u7AE0\u8282\u3001\u771F\u5B9E\u94FE\u63A5\u4F18\u5148\uFF1Bfrontmatter \u4E0E llms.txt \u4E3A\u53EF\u9009\u589E\u5F3A\uFF08D-4 \u51BB\u7ED3\uFF09\n    scores:\n      "0": \u65E0\u8BED\u4E49\u7ED3\u6784\uFF08\u7AE0\u8282\u540D\u4E3A Section 1 \u7C7B\u5360\u4F4D\uFF09\n      "1": \u6709\u7AE0\u8282\u4F46\u6807\u9898\u4E0D\u8BED\u4E49\u5316\uFF0C\u547D\u4EE4\u793A\u4F8B\u7528\u622A\u56FE\u800C\u975E\u4EE3\u7801\u5757\n      "2": \u5173\u952E\u7AE0\u8282\u7528\u8BED\u4E49\u6807\u9898\uFF08Installation/Quickstart/Usage \u7B49\uFF09\n      "3": \u6EE1\u8DB3 2 \u5206\uFF0C\u4E14\u547D\u4EE4\u793A\u4F8B\u5168\u90E8\u4E3A\u53EF\u590D\u5236\u4EE3\u7801\u5757\u3001\u94FE\u63A5\u771F\u5B9E\u6709\u6548\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u63D0\u4F9B\u53EF\u9009\u7684\u7ED3\u6784\u5316\u5143\u6570\u636E\uFF08frontmatter \u6216 llms.txt \u5176\u4E00\uFF09\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14 LLM \u4E94\u95EE\u6D4B\u8BD5\uFF08\u505A\u4EC0\u4E48/\u600E\u4E48\u88C5/\u600E\u4E48\u8DD1/\u5DEE\u5F02/\u8BB8\u53EF\u8BC1\uFF09\u5168\u90E8\u7B54\u5BF9\n    evidence: [semantic-headings, llm-five-questions]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 2, pass: 3 }\n\n  - id: T16\n    title: \u65E0\u969C\u788D a11y\n    axis: inclusive\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u56FE\u50CF alt \u5177\u4F53\u3001\u8868\u683C\u5E26 header\u3001\u4E0D\u4F9D\u8D56\u989C\u8272\u5355\u4E00\u4F20\u8FBE\u4FE1\u606F\n    scores:\n      "0": \u56FE\u50CF\u65E0 alt \u6216\u5168\u662F image/screenshot \u5360\u4F4D\n      "1": \u90E8\u5206\u56FE\u50CF\u6709 alt \u4F46\u4E0D\u5177\u4F53\n      "2": \u56FE\u50CF alt \u5177\u4F53\uFF0C\u4F46\u8868\u683C\u7F3A header \u884C\n      "3": \u5168\u90E8\u56FE\u50CF alt \u5177\u4F53 + \u5168\u90E8\u8868\u683C\u5E26 header\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u4E0D\u4F9D\u8D56\u989C\u8272\u5355\u4E00\u4F20\u8FBE\u4FE1\u606F\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u7ECF pa11y / axe-core \u626B\u63CF\u901A\u8FC7\n    evidence: [alt-text, table-headers]\n    evaluator: deterministic\n    browser_safe: true\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T17\n    title: \u9ED8\u8BA4\u8BED\u8A00\u7B56\u7565\n    axis: content\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: \u9ED8\u8BA4\u8BED\u8A00\u6309\u4E3B\u8981\u7528\u6237\u7FA4\u4F53\u53CD\u63A8\uFF0C\u4E0D\u7167\u642C\u5FC5\u987B\u82F1\u6587\u7684\u60EF\u4F8B\n    scores:\n      "0": \u9ED8\u8BA4\u8BED\u8A00\u4E0E\u7528\u6237\u7FA4\u4F53\u660E\u663E\u9519\u4F4D\uFF08\u89E6\u53D1 A11\uFF09\n      "1": \u9ED8\u8BA4\u8BED\u8A00\u5408\u7406\u4F46\u5224\u65AD\u4F9D\u636E\u672A\u8BF4\u660E\n      "2": \u6709\u5224\u65AD\u4F9D\u636E\uFF08\u4F5C\u8005\u8BED\u8A00/Issues \u8BED\u8A00/\u56E2\u961F\u6BCD\u8BED\uFF09\u4F46\u8BED\u8A00\u5207\u6362\u6563\u843D\u5168\u6587\n      "3": \u9ED8\u8BA4\u8BED\u8A00\u5339\u914D\u7528\u6237\u7FA4\u4F53 + \u5207\u6362\u94FE\u63A5\u96C6\u4E2D\u9876\u90E8\u4E00\u5904\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u53E6\u4E00\u8BED\u8A00\u7248\u672C\u5185\u5BB9\u540C\u6B65\u7EF4\u62A4\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u7B56\u7565\u5728 README \u4E2D\u663E\u5F0F\u8BF4\u660E\n    evidence: [default-language-rationale]\n    evaluator: agent-reviewed\n    thresholds: { partial: 1, pass: 3 }\n\n  - id: T18\n    title: \u622A\u56FE\u81EA\u52A8\u5316\n    axis: visual\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: README \u622A\u56FE\u5FC5\u987B\u7531\u811A\u672C\u4EA7\u751F\uFF08Playwright/VHS \u7B49\uFF09+ CI \u81EA\u52A8\u5316\uFF1B\u65E0\u622A\u56FE\u9879\u76EE\u53EF\u5224 N/A\n    scores:\n      "0": \u622A\u56FE\u624B\u5DE5\u7EF4\u62A4\uFF08\u6587\u4EF6\u540D\u5E26\u65E5\u671F/\u4E0E\u4EE3\u7801\u4E0D\u540C\u6B65\uFF09\n      "1": \u6709\u622A\u56FE\u811A\u672C\u4F46\u65E0 CI \u89E6\u53D1\n      "2": \u811A\u672C + CI \u5B58\u5728\uFF0C\u4F46\u6587\u4EF6\u540D/\u89C6\u53E3\u4E0D\u89C4\u8303\n      "3": \u811A\u672C\u4EA7\u751F + \u8BED\u4E49\u6587\u4EF6\u540D + \u56FA\u5B9A\u89C6\u53E3 + CI \u89E6\u53D1\uFF08push/\u5B9A\u65F6/\u624B\u52A8\uFF09\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14\u622A\u56FE\u8986\u76D6 README \u89C6\u89C9\u77E9\u9635\u5168\u90E8\u573A\u666F\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u5931\u8D25\u65F6 CI \u975E\u96F6\u9000\u51FA\u5E76\u53EF\u8BCA\u65AD\n    evidence: [screenshot-workflow, semantic-filenames]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 2, pass: 4 }\n\n  - id: T19\n    title: CI \u53EF\u590D\u73B0\u4E0E\u53EF\u8BCA\u65AD\n    axis: structure\n    applies_to: [cli, library, desktop, web-app, service, knowledge-base]\n    intent: lockfile \u5165\u5E93 + frozen install + \u7248\u672C\u56FA\u5B9A + \u94FE\u63A5\u68C0\u67E5\uFF1B\u65E0 CI \u7684\u9879\u76EE\u53EF\u5224 N/A\n    scores:\n      "0": lockfile \u88AB .gitignore \u6392\u9664\u6216 CI \u7ED5\u5F00 frozen install\uFF08\u89E6\u53D1 A13\uFF09\n      "1": lockfile \u5165\u5E93\u4F46 CI \u672A\u7528 frozen install\n      "2": frozen install \u5C31\u4F4D\uFF0C\u4F46\u8FD0\u884C\u65F6/\u5305\u7BA1\u7406\u5668\u7248\u672C\u672A\u56FA\u5B9A\n      "3": lockfile + frozen install + packageManager/Node \u7248\u672C\u56FA\u5B9A\n      "4": \u6EE1\u8DB3 3 \u5206\uFF0C\u4E14 README \u76F8\u5BF9\u94FE\u63A5\u4E0E\u53CC\u8BED\u6587\u4EF6\u5B58\u5728\u6027\u68C0\u67E5\u8FDB CI\n      "5": \u6EE1\u8DB3 4 \u5206\uFF0C\u4E14\u5931\u8D25\u4FE1\u606F\u6307\u660E\u7F3A\u5931\u6587\u4EF6\u4E0E\u4FEE\u590D\u52A8\u4F5C\uFF08\u53EF\u8BCA\u65AD\uFF09\n    evidence: [lockfile-committed, frozen-install, pinned-versions]\n    evaluator: deterministic\n    browser_safe: false\n    thresholds: { partial: 2, pass: 4 }\n\nantiPatterns:\n  - id: A01\n    title: \u96F6\u89C6\u89C9\n    maps_to: [T01, T06]\n  - id: A02\n    title: \u5185\u90E8 jargon \u4E3B\u5BFC\n    maps_to: [T02]\n  - id: A03\n    title: Checklist \u5806\u780C\n    maps_to: [T07]\n  - id: A04\n    title: \u5B89\u88C5\u57CB\u5728\u7B2C 5 \u5C4F\n    maps_to: [T04]\n  - id: A05\n    title: \u6CA1 demo \u622A\u56FE\n    maps_to: [T06, T05]\n  - id: A06\n    title: \u7FFB\u8BD1\u5217\u9635\n    maps_to: [T13]\n  - id: A07\n    title: \u6CA1"\u4E3A\u4EC0\u4E48\u7528\u6211"\n    maps_to: [T10]\n  - id: A08\n    title: \u6CA1\u7248\u672C/\u72B6\u6001\n    maps_to: [T03]\n  - id: A09\n    title: \u96F6 i18n \u4F46\u6709\u6D77\u5916\u7528\u6237\n    maps_to: [T13]\n  - id: A10\n    title: emoji \u6EE1\u5C4F\u65E0\u5B9E\u8D28\n    maps_to: [T07, T14]\n  - id: A11\n    title: \u9ED8\u8BA4\u8BED\u8A00\u9519\u4F4D\n    maps_to: [T17]\n  - id: A12\n    title: \u622A\u56FE\u624B\u5DE5\u7EF4\u62A4\n    maps_to: [T18]\n  - id: A13\n    title: CI \u4E0D\u53EF\u590D\u73B0\n    maps_to: [T19]\n', schemaJson: '{\n  "$schema": "https://json-schema.org/draft/2020-12/schema",\n  "$id": "https://github.com/davyzhong/readme-craft/rules.schema.json",\n  "title": "readme-craft \u89C4\u5219\u89C4\u8303\uFF08rules.yaml\uFF09",\n  "type": "object",\n  "required": ["version", "rules", "antiPatterns"],\n  "additionalProperties": false,\n  "properties": {\n    "version": {\n      "type": "string",\n      "pattern": "^\\\\d+\\\\.\\\\d+\\\\.\\\\d+(-[0-9A-Za-z.-]+)?$",\n      "description": "\u89C4\u8303\u7248\u672C\uFF1B\u5FC5\u987B\u4E0E SKILL frontmatter \u53CA package.json version \u4E00\u81F4\uFF08P9\uFF09"\n    },\n    "rules": {\n      "type": "array",\n      "minItems": 1,\n      "items": { "$ref": "#/$defs/rule" }\n    },\n    "antiPatterns": {\n      "type": "array",\n      "items": { "$ref": "#/$defs/antiPattern" }\n    }\n  },\n  "$defs": {\n    "projectType": {\n      "type": "string",\n      "enum": ["cli", "library", "desktop", "web-app", "service", "knowledge-base"]\n    },\n    "evaluator": {\n      "type": "string",\n      "enum": ["deterministic", "agent-reviewed"]\n    },\n    "axis": {\n      "type": "string",\n      "enum": ["structure", "content", "visual", "ai", "inclusive"]\n    },\n    "rule": {\n      "type": "object",\n      "required": [\n        "id",\n        "title",\n        "axis",\n        "applies_to",\n        "intent",\n        "scores",\n        "evidence",\n        "evaluator",\n        "thresholds"\n      ],\n      "additionalProperties": false,\n      "properties": {\n        "id": {\n          "type": "string",\n          "pattern": "^T(0[1-9]|1[0-9])$",\n          "description": "\u89C4\u8303\u5185\u90E8 ID\uFF0C\u96F6\u586B\u5145 T01..T19\uFF1B\u6563\u6587\u5199\u6CD5 T1..T19 \u7531 generate \u6620\u5C04"\n        },\n        "title": { "type": "string", "minLength": 1 },\n        "axis": { "$ref": "#/$defs/axis" },\n        "applies_to": {\n          "type": "array",\n          "minItems": 1,\n          "uniqueItems": true,\n          "items": { "$ref": "#/$defs/projectType" }\n        },\n        "intent": { "type": "string", "minLength": 1 },\n        "scores": {\n          "type": "object",\n          "required": ["0", "1", "2", "3", "4", "5"],\n          "additionalProperties": false,\n          "properties": {\n            "0": { "type": "string", "minLength": 1 },\n            "1": { "type": "string", "minLength": 1 },\n            "2": { "type": "string", "minLength": 1 },\n            "3": { "type": "string", "minLength": 1 },\n            "4": { "type": "string", "minLength": 1 },\n            "5": { "type": "string", "minLength": 1 }\n          }\n        },\n        "evidence": {\n          "type": "array",\n          "minItems": 1,\n          "items": { "type": "string", "minLength": 1 }\n        },\n        "evaluator": { "$ref": "#/$defs/evaluator" },\n        "browser_safe": {\n          "type": "boolean",\n          "description": "\u662F\u5426\u53EF\u5728\u6D4F\u89C8\u5668\u4E2D\u8FD0\u884C\uFF08\u4EC5\u4F9D\u8D56 Markdown \u5B57\u7B26\u4E32\uFF09\uFF1Bdeterministic \u89C4\u5219\u5FC5\u987B\u58F0\u660E\uFF0Cagent-reviewed \u4E0D\u5F97\u4E3A true"\n        },\n        "thresholds": {\n          "type": "object",\n          "required": ["partial", "pass"],\n          "additionalProperties": false,\n          "properties": {\n            "partial": { "type": "integer", "minimum": 0, "maximum": 5 },\n            "pass": { "type": "integer", "minimum": 0, "maximum": 5 }\n          }\n        }\n      }\n    },\n    "antiPattern": {\n      "type": "object",\n      "required": ["id", "title", "maps_to"],\n      "additionalProperties": false,\n      "properties": {\n        "id": {\n          "type": "string",\n          "pattern": "^A(0[1-9]|1[0-3])$"\n        },\n        "title": { "type": "string", "minLength": 1 },\n        "maps_to": {\n          "type": "array",\n          "minItems": 1,\n          "uniqueItems": true,\n          "items": { "type": "string", "pattern": "^T(0[1-9]|1[0-9])$" }\n        }\n      }\n    }\n  }\n}\n', version: "3.0.0-alpha.0" };
  }
});

// scripts/lib/skill.ts
var skill_exports = {};
__export(skill_exports, {
  SkillConflictError: () => SkillConflictError,
  buildSkillPayload: () => buildSkillPayload,
...
function buildSkillPayload(root) {
...
function packSkill(root, outDir) {
...
function installSkill(root, target, opts = {}) {
...
var WHITELIST, SkillConflictError;
var init_skill = __esm({
  "scripts/lib/skill.ts"() {
    "use strict";
    init_define_README_CRAFT_EMBEDDED();
    WHITELIST = {
    ...
    SkillConflictError = class extends Error {
      diff;
      constructor(diff) {
...
function proseId(internalId2) {
  return internalId2.replace(/^([TA])0(\d)$/, "$1$2");
}
function internalId(prose) {
  return prose.replace(/^([TA])(\d)$/, "$10$2");
}
var PROJECT_TYPES, SCORE_LEVELS;
...
function toolVersion() {
  ...
  return JSON.parse(readFileSync2(path2.join(repoRoot, "package.json"), "utf8")).version;
}
function formatAjvErrors() {
  return (validateSchema.errors ?? []).map((e) => `  ${e.instancePath || "/"} ${e.message ?? ""}`).join("\n");
}
function validateSpecSemantics(spec) {
  ...
  const antiIds = /* @__PURE__ */ new Set();
...
function parseSpec(text) {
  let data;
  try {
    data = import_yaml.default.parse(text);
  } catch (err) {
    throw new SchemaError(`rules.yaml \u4E0D\u662F\u5408\u6CD5 YAML\uFF1A${err.message}`);
  }
...
function loadSpec(specPath) {
  ...
  let text;
  try {
    text = readFileSync2(resolved, "utf8");
  } catch {
    throw new SchemaError(`\u627E\u4E0D\u5230\u89C4\u5219\u89C4\u8303\u6587\u4EF6\uFF1A${resolved}`);
  }
  return parseSpec(text);
}
var import_yaml, import__, SchemaError, SemanticError, embedded, repoRoot, SCHEMA_PATH, SPEC_PATH, ajv, validateSchema;
var init_spec = __esm({
  "scripts/lib/spec.ts"() {
    "use strict";
    init_define_README_CRAFT_EMBEDDED();
    ...
    embedded = typeof define_README_CRAFT_EMBEDDED_default === "undefined" ? void 0 : define_README_CRAFT_EMBEDDED_default;
    repoRoot = path2.resolve(path2.dirname(fileURLToPath(import.meta.url)), "..", "..");
    SCHEMA_PATH = path2.join(repoRoot, "rules.schema.json");
    SPEC_PATH = path2.join(repoRoot, "rules.yaml");
    ajv = new import__.Ajv2020({ allErrors: true });
    validateSchema = ajv.compile(
      JSON.parse(embedded ? embedded.schemaJson : readFileSync2(SCHEMA_PATH, "utf8"))
    );
  }
});
...
__export(generate_exports, {
  ...
  renderAntiPatternSummary: () => renderAntiPatternSummary,
  renderBannerStats: () => renderBannerStats,
  renderRuleSummary: () => renderRuleSummary,
  renderRulesProjection: () => renderRulesProjection,
  renderScoringTable: () => renderScoringTable,
  renderSkillChecklist: () => renderSkillChecklist,
...
function applyBlock(content, name, inner) {
...
function renderVersionSummary(spec) {
  return `> \u89C4\u8303\u7248\u672C **${spec.version}** \xB7 **${spec.rules.length}** \u6761\u94C1\u5F8B \xB7 **${spec.antiPatterns.length}** \u6761\u53CD\u6A21\u5F0F \xB7 \u8BC4\u5206\u5BF9\u5916\u5C55\u793A\uFF1A\u5F52\u4E00\u5316\u767E\u5206\u5236 + \u9002\u7528\u9879\u6570 + \u672A\u6838\u9A8C\u9879\u6570\uFF08\u539F\u59CB\u5F97\u5206 / \u9002\u7528\u6EE1\u5206\u89C1\u68C0\u67E5\u62A5\u544A\uFF09`;
}
function renderRuleSummary(spec) {
  const rows = spec.rules.map(
    (r) => `| **${proseId(r.id)}** | ${r.title} | ${AXIS_LABELS[r.axis]} | ${r.intent} | ${EVALUATOR_LABELS[r.evaluator]} |`
  );
  return [
    "| # | \u94C1\u5F8B | \u8F74 | \u6838\u5FC3\u52A8\u4F5C | \u8BC4\u4F30\u65B9\u5F0F |",
    "|---|---|---|---|---|",
...
function renderAntiPatternSummary(spec) {
  const rows = spec.antiPatterns.map(
    (a) => `| **${proseId(a.id)}** | ${a.title} | ${a.maps_to.map(proseId).join(" / ")} |`
  );
  return ["| # | \u53CD\u6A21\u5F0F | \u89E3\u836F |", "|---|---|---|", ...rows].join("\n");
}
function renderScoringTable(spec) {
  const rows = spec.rules.map(
    (r) => `| ${proseId(r.id)} ${r.title} | ${AXIS_LABELS[r.axis]} | ${EVALUATOR_LABELS[r.evaluator]} | \u2705/\u26A0\uFE0F/\u274C/N/A | _/5 |`
  );
  return [
...
function renderSkillChecklist(spec) {
  const rows = spec.rules.map(
  ...
  return [
    ...
    ...rows,
    "",
    "**\u8BC4\u5206\u53E3\u5F84**\uFF1A\u5F52\u4E00\u5316\u767E\u5206\u5236\uFF08\u5F97\u5206 / \u9002\u7528\u9879\u6EE1\u5206 \xD7 100\uFF09+ \u9002\u7528\u9879\u6570 + \u672A\u6838\u9A8C\u9879\u6570\uFF1Bagent-reviewed \u89C4\u5219\u9ED8\u8BA4 unverified\uFF0C\u4E0D\u4F2A\u9020\u5206\u6570\u3002"
  ].join("\n");
}
function renderBannerStats(spec) {
  return `<text x="600" y="118" text-anchor="middle" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" font-size="20" font-weight="400" fill="#c7d2fe">${spec.rules.length} \u6761\u94C1\u5F8B \xB7 ${spec.antiPatterns.length} \u6761\u53CD\u6A21\u5F0F \xB7 \u91CF\u5316\u8BC4\u5206 \xB7 craft-readme Skill</text>`;
}
function renderRulesProjection(spec) {
...
function generateAll(root, opts) {
  const spec = opts.spec ?? loadSpec(path3.join(root, "rules.yaml"));
  const blocks = opts.blocks ?? GENERATED_BLOCKS;
  const stale = [];
  for (const block of blocks) {
    const filePath = path3.join(root, block.file);
    if (block.wholeFile) {
      const after2 = block.render(spec);
      const before2 = existsSync2(filePath) ? readFileSync3(filePath, "utf8") : null;
      if (before2 !== after2) {
        stale.push(block.file);
        if (!opts.check) {
          mkdirSync2(path3.dirname(filePath), { recursive: true });
          writeFileSync2(filePath, after2);
        }
      }
      continue;
    }
    ...
    const before = readFileSync3(filePath, "utf8");
    const after = applyBlock(before, block.name, block.render(spec));
    if (after !== before) {
      stale.push(block.file);
      if (!opts.check) writeFileSync2(filePath, after);
    }
  }
  return { stale };
}
var GenerateError, AXIS_LABELS, EVALUATOR_LABELS, GENERATED_BLOCKS;
...
__export(validate_exports, {
  checkGeneratedFreshness: () => checkGeneratedFreshness,
  checkLinks: () => checkLinks,
  checkPlaceholders: () => checkPlaceholders,
  checkRuleRefs: () => checkRuleRefs,
  checkScaleDrift: () => checkScaleDrift,
...
function checkVersionConsistency(root, spec) {
  const issues = [];
  ...
  const skillPath = path4.join(root, "skill", "SKILL.md");
  if (!existsSync3(skillPath)) {
    issues.push({ check: "version", file: "skill/SKILL.md", message: "skill/SKILL.md \u4E0D\u5B58\u5728" });
  } else {
    const text = readFileSync4(skillPath, "utf8");
    const fm = text.match(/^---\n([\s\S]*?)\n---/);
    const version = fm ? import_yaml2.default.parse(fm[1] ?? "").version : void 0;
...
function checkScaleDrift(root) {
  const issues = [];
  const files = walkMd(root, root).filter(
    (f) => !f.startsWith(`docs${path4.sep}superpowers${path4.sep}`) && !DRIFT_EXEMPT_FILES.has(f)
  );
  for (const rel of files) {
    const lines = stripCode(readFileSync4(path4.join(root, rel), "utf8")).split("\n");
    let heading = "";
    for (const line of lines) {
...
function extractLinks(rel, text) {
...
function checkLinks(root) {
  ...
  const anchorsOf = (rel) => {
    if (!anchorCache.has(rel)) {
      anchorCache.set(rel, collectAnchors(readFileSync4(path4.join(root, rel), "utf8")));
    }
    return anchorCache.get(rel) ?? /* @__PURE__ */ new Set();
  };
  for (const rel of files) {
    const text = readFileSync4(path4.join(root, rel), "utf8");
...
function checkPlaceholders(root) {
  ...
  for (const rel of walkMd(root, root)) {
    if (PLACEHOLDER_EXEMPT(rel)) continue;
    const text = stripCode(readFileSync4(path4.join(root, rel), "utf8"));
    for (const line of text.split("\n")) {
...
function checkGeneratedFreshness(root, spec, blocks) {
  const issues = [];
  try {
...
function checkRuleRefs(root, spec) {
  const issues = [];
  const read = (rel) => readFileSync4(path4.join(root, rel), "utf8");
  const ruleDocs = ["METHODOLOGY.md", "checklist.md", `skill${path4.sep}SKILL.md`];
  for (const rel of ruleDocs) {
    if (!existsSync3(path4.join(root, rel))) continue;
    const text = read(rel);
    for (const rule of spec.rules) {
...
function validateRepo(root) {
  const spec = loadSpec(path4.join(root, "rules.yaml"));
  const issues = [
...
var import_yaml2, SKIP_DIRS, DRIFT_PATTERN, HISTORY_LINE, HISTORY_HEADING, DRIFT_EXEMPT_FILES, PLACEHOLDER_PATTERN, PLACEHOLDER_EXEMPT;
...
function assertLegal(types, origin) {
  for (const t of types) {
    if (!PROJECT_TYPES.includes(t)) {
...
function detect(root) {
  ...
  const has = (f) => existsSync4(path5.join(root, f));
  ...
  if (has("Package.swift") || readdirSync3(root).some((f) => f.endsWith(".xcodeproj"))) {
    found.add("desktop");
  }
  if (has("index.html")) found.add("web-app");
  if (has("Dockerfile") || has("docker-compose.yml")) found.add("service");
  if (has("pyproject.toml")) {
    const text = readFileSync5(path5.join(root, "pyproject.toml"), "utf8");
    found.add(text.includes("[project.scripts]") ? "cli" : "library");
  }
  if (has("Cargo.toml")) {
    found.add(has(path5.join("src", "main.rs")) ? "cli" : "library");
  }
  if (found.size === 0) {
    const mdCount = readdirSync3(root).filter((f) => f.endsWith(".md")).length;
    if (mdCount >= 2) found.add("knowledge-base");
  }
  return [...found];
}
function resolveProjectTypes(root, opts) {
  if (opts.types && opts.types.length > 0) {
    return { types: assertLegal(opts.types, "--type"), source: "cli", ambiguous: false };
  }
  const configPath = path5.join(root, ".readme-craft.yaml");
  if (existsSync4(configPath)) {
    const config = import_yaml3.default.parse(readFileSync5(configPath, "utf8"));
    ...
    return {
      types: assertLegal(config.projectTypes, ".readme-craft.yaml"),
      source: "config",
      ambiguous: false
    };
  }
...
var import_yaml3, ProjectTypeError;
var init_project = __esm({
  "scripts/lib/project.ts"() {
    ...
    init_types();
    ProjectTypeError = class extends Error {
...
var na, unverified, score, GENERIC_ALTS, CONTENT_CHECKERS;
var init_content_checks = __esm({
  "scripts/lib/content-checks.ts"() {
    "use strict";
    init_define_README_CRAFT_EMBEDDED();
    na = (reason) => ({ kind: "na", reason });
    unverified = (reason) => ({ kind: "unverified", reason });
    score = (s, evidence, reason) => ({
      kind: "score",
      score: s,
      evidence,
      reason
    });
    GENERIC_ALTS = /* @__PURE__ */ new Set(["image", "img", "screenshot", "picture", "photo", "icon", "\u56FE", "\u622A\u56FE"]);
    CONTENT_CHECKERS = {
      T03(ctx) {
...
import { existsSync as existsSync5, readdirSync as readdirSync4, readFileSync as readFileSync6, writeFileSync as writeFileSync3, renameSync } from "node:fs";
import path6 from "node:path";
function listDir(ctx, rel) {
  const dir = path6.join(ctx.root, rel);
  return existsSync5(dir) ? readdirSync4(dir) : [];
}
function readRel(ctx, rel) {
  const p = path6.join(ctx.root, rel);
  return existsSync5(p) ? readFileSync6(p, "utf8") : null;
}
function parseReviewFile(reviewPath, spec) {
  const result = { scored: /* @__PURE__ */ new Map(), na: /* @__PURE__ */ new Map(), errors: [] };
  let data;
  try {
    data = import_yaml4.default.parse(readFileSync6(reviewPath, "utf8"));
  } catch (err) {
    result.errors.push(`review \u6587\u4EF6\u89E3\u6790\u5931\u8D25\uFF1A${err.message}`);
    return result;
  }
  const entries = data?.reviews;
...
function checkProject(projectRoot, opts) {
  const spec = loadSpec();
  const resolution = resolveProjectTypes(projectRoot, { ...opts.types ? { types: opts.types } : {} });
  const readmePath = path6.join(projectRoot, "README.md");
  const errors = [];
  let readme = "";
  if (existsSync5(readmePath)) {
    readme = readFileSync6(readmePath, "utf8");
  } else {
  ...
  const ctx = { root: projectRoot, readme, types: resolution.types };
  const results = [];
  for (const rule of spec.rules) {
    const base = {
      id: rule.id,
    ...
    const outcome = CHECKERS[rule.id]?.(ctx) ?? { kind: "unverified", reason: "\u8BE5\u786E\u5B9A\u6027\u89C4\u5219\u6682\u65E0\u68C0\u67E5\u5668" };
...
function renderText(report, source) {
  ...
  lines.push(`\u89C4\u8303\u7248\u672C\uFF1A${report.specVersion} \xB7 \u5DE5\u5177\u7248\u672C\uFF1A${report.toolVersion}`);
  lines.push("");
...
function exitCodeOf(report, strict) {
...
function emitReport(report, format, output) {
...
var import_yaml4, TOOL_VERSION, CHECKERS;
  ...
  "scripts/lib/check.ts"() {
    ...
    CHECKERS = {
      ...
      T06(ctx) {
        ...
        if (s === 3 && hasVideo) s = 4;
        const automated = listDir(ctx, "scripts").some((f) => /screenshot/i.test(f)) || listDir(ctx, ".github/workflows").some((f) => /screenshot|vhs|playwright/i.test(f));
      ...
      T12(ctx) {
        ...
        return score(s, present, `\u6CBB\u7406\u6587\u4EF6\u9F50\u5907\u5EA6\u5230 ${s} \u5206\u6863`);
      },
      T13(ctx) {
        const files = listDir(ctx, ".");
      ...
      T15(ctx) {
        ...
        if (fm?.[1] !== void 0) {
          try {
            import_yaml4.default.parse(fm[1]);
          } catch (e) {
        ...
        const semantic = headings.filter(
          (h) => /install|安装|quickstart|快速|usage|使用|architect|架构|features?|特性|license|许可/i.test(h)
        );
        if (semantic.length < 2) return score(1, [`semantic-headings=${semantic.length}`], "\u8BED\u4E49\u5316\u7AE0\u8282\u6807\u9898\u4E0D\u8DB3");
        const hasFence = /```/.test(ctx.readme);
        let s = 2;
        if (hasFence) s = 3;
        const hasMeta = /^---\n[\s\S]*?\n---/.test(ctx.readme) || existsSync5(path6.join(ctx.root, "llms.txt"));
        if (s >= 3 && hasMeta) s = 4;
      ...
      T19(ctx) {
        ...
        const pinned = (pkg ? "packageManager" in JSON.parse(pkg) : false) || files.includes(".node-version") || files.includes(".nvmrc") || /node-version/i.test(wfText);
...
// scripts/readme-craft.ts
init_define_README_CRAFT_EMBEDDED();
import path7 from "node:path";
import { existsSync as existsSync6 } from "node:fs";
import { fileURLToPath as fileURLToPath2 } from "node:url";
var SUBCOMMANDS = ["validate", "generate", "check", "pack-skill", "install-skill"];
var USAGE = `readme-craft \u2014 README \u65B9\u6CD5\u8BBA\u5DE5\u5177\u94FE\uFF08rules.yaml \u5355\u4E00\u4E8B\u5B9E\u6E90\uFF09
...
async function runPackSkill(argv) {
  if (argv.length > 0) {
    process.stderr.write(`pack-skill \u4E0D\u652F\u6301\u53C2\u6570\uFF1A${argv.join(" ")}
`);
    return 2;
  }
  const { packSkill: packSkill2 } = await Promise.resolve().then(() => (init_skill(), skill_exports));
  const repoRoot2 = path7.resolve(path7.dirname(fileURLToPath2(import.meta.url)), "..");
  const { outDir, written } = packSkill2(repoRoot2);
  process.stdout.write(`Skill \u5305\u5DF2\u751F\u6210\uFF1A${path7.relative(repoRoot2, outDir)}\uFF08${written.length} \u4E2A\u6587\u4EF6\uFF09
`);
  return 0;
}
async function runInstallSkill(argv) {
  ...
  const { installSkill: installSkill2, SkillConflictError: SkillConflictError2 } = await Promise.resolve().then(() => (init_skill(), skill_exports));
  const repoRoot2 = path7.resolve(path7.dirname(fileURLToPath2(import.meta.url)), "..");
  try {
    const { status } = installSkill2(repoRoot2, path7.resolve(target), { replace });
...
`);
    ...
    if (err instanceof SkillConflictError2) {
...
`);
  ...
  try {
    const { generateAll: generateAll2 } = await Promise.resolve().then(() => (init_generate(), generate_exports));
    const repoRoot2 = path7.resolve(path7.dirname(fileURLToPath2(import.meta.url)), "..");
    const result = generateAll2(repoRoot2, { check });
...
`);
  ...
  try {
    const { validateRepo: validateRepo2 } = await Promise.resolve().then(() => (init_validate(), validate_exports));
    const repoRoot2 = path7.resolve(path7.dirname(fileURLToPath2(import.meta.url)), "..");
    const { issues } = validateRepo2(repoRoot2);
    if (issues.length > 0) {
...
async function runCheck(argv) {
  ...
  const projectRoot = path7.resolve(target);
  if (!existsSync6(projectRoot)) return usageError(`\u8DEF\u5F84\u4E0D\u5B58\u5728\uFF1A${projectRoot}`);
  try {
    const { checkProject: checkProject2, emitReport: emitReport2, exitCodeOf: exitCodeOf2 } = await Promise.resolve().then(() => (init_check(), check_exports));
    const report = checkProject2(projectRoot, {
      types,
    ...
    process.stdout.write(emitReport2(report, format, output));
    return exitCodeOf2(report, strict);
  } catch (err) {
